...
class MultiHeadAttention(nn.Module):
    def __init__(self, embedding_dim, head_size, block_size, dropout, num_heads):
        ...
        self.heads = nn.ModuleList(
            [
                SelfAttentionHead(
                    embedding_dim, head_size // num_heads, block_size, dropout
                )
...
class Block(nn.Module):
    def __init__(self, embedding_dim, head_size, block_size, dropout, num_heads):
        ...
        self.multi_head_attention = MultiHeadAttention(
            embedding_dim, head_size, block_size, dropout, num_heads
        )
...
class GPTLanguageModel(nn.Module):
    ...
    def __init__(
        ...
        self.blocks = nn.Sequential(
            *[
                Block(embedding_dim, head_size, block_size, dropout, num_heads)
